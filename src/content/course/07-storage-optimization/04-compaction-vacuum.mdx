...
<Callout type="tip">
Для углублённого изучения maintenance-операций lakehouse-форматов см. курс [Storage Formats Deep-Dive](/storage-formats/11-delta-lake/01-transaction-log-architecture/) — compaction и vacuum в Delta Lake, и [maintenance в Iceberg](/storage-formats/12-iceberg/01-catalog-architecture-metadata/) (expire snapshots, rewrite data files).
</Callout>

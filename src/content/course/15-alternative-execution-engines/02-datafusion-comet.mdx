...
Последний релиз -- **0.13.0** (январь 2026), 169 PR от 15 контрибьюторов. Comet проходит **97% тестов Spark SQL** (24,000+ тестов по состоянию на v0.9.0), что делает его одним из наиболее совместимых нативных ускорителей.
...
```bash
spark-submit \
  --jars comet-spark-spark3.5_2.12-0.13.0.jar \
  --conf spark.driver.extraClassPath=comet-spark-spark3.5_2.12-0.13.0.jar \
  --conf spark.executor.extraClassPath=comet-spark-spark3.5_2.12-0.13.0.jar \

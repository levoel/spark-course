...
<CrossCourseRef
  ...
  lessonSlug="10-data-libraries-conceptual/01-pandas-concept"
  label="Pandas vs Spark DataFrame: концептуальная разница"
  preview="Где заканчивается pandas (single-machine, eager) и начинается Spark DataFrame (distributed, lazy). Полезно для миграции мышления из pandas в PySpark."
/>

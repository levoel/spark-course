...
<Callout type="tip">
Для углублённого изучения внутренней архитектуры Paimon (LSM-tree, changelog, merge engines) см. курс [Storage Formats Deep-Dive](/storage-formats/14-paimon/01-lsm-tree-architecture/).
</Callout>

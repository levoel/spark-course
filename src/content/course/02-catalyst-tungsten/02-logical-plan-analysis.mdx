...
<CrossCourseRef
  ...
  lessonSlug="06-query-optimization/02-logical-optimization-rules"
  label="DataFusion: правила логической оптимизации"
  preview="Аналог Catalyst Optimizer в DataFusion — predicate pushdown, projection pushdown, constant folding. Полезно увидеть тот же набор правил в другом движке."
/>

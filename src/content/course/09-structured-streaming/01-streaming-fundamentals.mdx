...
<CrossCourseRef
  ...
  lessonSlug="01-kafka-architecture/02-brokers-topics-partitions"
  label="Kafka: брокеры, топики и партиции"
  preview="Базовая модель Kafka — брокеры, топики, партиции. Это фундамент для понимания Kafka source в Structured Streaming."
/>

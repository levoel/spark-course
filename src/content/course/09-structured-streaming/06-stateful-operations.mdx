...
В следующем уроке мы рассмотрим **CDC и Debezium** -- как потреблять Change Data Capture события из Debezium через Kafka и трансформировать их в Delta Lake с помощью Structured Streaming.

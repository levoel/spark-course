    ...
    <DiagramContainer title="Per-row (cloudpickle) vs Per-batch (Arrow)" color="emerald">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="bg-rose-500/10 border border-rose-500/20 rounded-lg p-3 space-y-1">
            {[
              ...
              <div class="flex items-center justify-between text-[11px] font-mono text-rose-700/80">
                <span>{row.label}</span>
                <span class="text-rose-400/50">{row.extra}</span>
              </div>
            ))}
            <div class="text-[10px] text-[var(--ink-subtle)] pt-1">...</div>
            <div class="text-[11px] font-mono text-rose-400 font-semibold pt-1">
              N serializations
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3 space-y-1">
            <div class="text-[11px] font-mono text-emerald-700/80">
              Column A: [1, 2, 3...]
            </div>
            <div class="text-[11px] font-mono text-emerald-700/80">
              Column B: [2, 4, 6...]
            </div>
            <div class="h-px bg-emerald-400/20 my-2" />

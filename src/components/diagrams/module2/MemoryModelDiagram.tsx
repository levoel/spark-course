...
export function MemoryModelDiagram() {
  const [memoryFraction, setMemoryFraction] = createSignal(60); // 0.6 * 100
  const [storageFraction, setStorageFraction] = createSignal(50); // 0.5 * 100
  ...
  return (
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        {isDangerZone() && (
          <div class="rounded-lg border border-rose-400/40 bg-rose-500/10 px-4 py-3 text-sm text-rose-700">
        ...
        {regions().executionMemory < 150 && (
          <div class="rounded-lg border border-red-500/40 bg-red-500/15 px-4 py-3 text-sm text-red-700">

  ...
  return (
    <DiagramContainer title="DataFusion Architecture" color="cyan">
      <div class="rounded-xl border border-cyan-400/20 bg-cyan-500/5 p-4">
        <div class="text-xs text-cyan-700/70 mb-3">DataFusion</div>
        ...
        <FlowColumn gap={10} align="center">
          <FlowRow gap={4} wrap align="center">
            <FlowNode variant="service" size="sm">
              <FlowColumn gap={0} align="center">
                ...
                <span class="text-[9px] opacity-70">+ Planner</span>
              </FlowColumn>
            </FlowNode>
            ...
            <FlowNode variant="compute" size="sm">
              <FlowColumn gap={0} align="center">
                <span>Logical</span>
                <span class="text-[9px] opacity-70">Optimizer</span>
              </FlowColumn>
            </FlowNode>
            <Arrow direction="right" />
            <FlowNode variant="compute" size="sm">
              <FlowColumn gap={0} align="center">
                <span>Physical</span>
                <span class="text-[9px] opacity-70">Executor</span>
              </FlowColumn>
            </FlowNode>
          </FlowRow>
          ...
          <FlowNode variant="storage" size="md">
            <FlowColumn gap={1} align="center">
              ...
              <span class="text-xs opacity-70">(columnar, zero-copy)</span>
            </FlowColumn>
          </FlowNode>
        </FlowColumn>
      </div>

        ...
        <FlowColumn gap={4} align="stretch">
          ...
          <div className="rounded-lg border border-amber-400/15 bg-amber-500/5 p-3">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-gray-400">K-Fold Cross-Validation</span>
              <span className="text-[10px] text-amber-300 font-mono">× 18 params</span>
            </div>
            {[1, 2, 3].map((fold) => (
          ...
          {/* Steps */}
          <div className="space-y-2 text-xs text-gray-300 pl-2">

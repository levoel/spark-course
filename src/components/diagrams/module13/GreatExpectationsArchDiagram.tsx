...
export function GreatExpectationsArchDiagram() {
  return (
    <DiagramContainer title="Great Expectations Architecture" color="purple">
      <div class="rounded-xl border border-purple-400/20 bg-purple-500/5 p-4">
        <div class="text-xs text-purple-700/70 mb-3">Data Context (центральная конфигурация проекта)</div>
        ...
        <FlowColumn gap={10} align="center">
          ...
          <FlowRow gap={6} wrap align="start">
            <FlowNode variant="database" size="sm">
              <FlowColumn gap={1} align="center">
                ...
                <span class="text-[10px] opacity-70">Spark DF · Pandas DF · SQL DB</span>
              </FlowColumn>
            </FlowNode>
            <FlowNode variant="security" size="sm">
              <FlowColumn gap={1} align="center">
                <span>Expectation Suites</span>
                <span class="text-[10px] opacity-70">[правила]</span>
              </FlowColumn>
            </FlowNode>
            <FlowNode variant="service" size="sm">
              <FlowColumn gap={1} align="center">
                <span>Checkpoint</span>
                <span class="text-[10px] opacity-70">[запуск валидации]</span>
              </FlowColumn>
            </FlowNode>
          </FlowRow>
          ...
          <FlowNode variant="compute" size="md">
            <FlowColumn gap={1} align="center">
              <span>Validator</span>
              <span class="text-xs opacity-70">(проверяет данные)</span>
            </FlowColumn>
          </FlowNode>
          ...
          <FlowNode variant="sink" size="md">
            <FlowColumn gap={1} align="center">
              <span>Data Docs</span>
              <span class="text-xs opacity-70">(HTML отчёт)</span>
            </FlowColumn>
          </FlowNode>
        </FlowColumn>
      </div>

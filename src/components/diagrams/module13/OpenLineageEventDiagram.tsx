        ...
        <FlowColumn gap={10} align="center">
          ...
          <FlowRow gap={8} wrap align="center">
            <FlowNode variant="database" size="sm">
              <FlowColumn gap={1} align="center">
                ...
                <span class="text-[10px] opacity-70">namespace · name · facets</span>
              </FlowColumn>
            </FlowNode>
          ...
          <FlowRow gap={8} wrap align="center">
            <FlowNode variant="compute" size="sm">
              <FlowColumn gap={1} align="center">
                <span>Job</span>
                <span class="text-[10px] opacity-70">name · facets</span>
              </FlowColumn>
            </FlowNode>
            <Arrow direction="right" />
            <FlowNode variant="service" size="sm">
              <FlowColumn gap={1} align="center">
                <span>Run</span>
                <span class="text-[10px] opacity-70">id · state · facets</span>
              </FlowColumn>
            </FlowNode>
          </FlowRow>
        </FlowColumn>

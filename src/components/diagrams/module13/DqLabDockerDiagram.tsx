  ...
  return (
    <DiagramContainer title="Docker Compose Lab" color="blue">
      <div class="rounded-xl border border-blue-400/20 bg-blue-500/5 p-4">
        <div class="text-xs text-blue-700/70 mb-3">Docker Compose</div>
        ...
        <FlowColumn gap={10} align="center">
          <FlowRow gap={8} wrap align="start">
            ...
            <FlowNode variant="cluster" size="sm">
              <FlowColumn gap={1} align="center">
                ...
                <span class="text-[10px] opacity-70">spark:4.0.0</span>
                <span class="text-[10px] opacity-70">Port: 8080</span>
              </FlowColumn>
            </FlowNode>
            ...
            <FlowNode variant="app" size="sm">
              <FlowColumn gap={1} align="center">
                ...
                <span class="text-[10px] opacity-70">PySpark + great-expectations</span>
                <span class="text-[10px] opacity-70">Port: 8888</span>
              </FlowColumn>
            </FlowNode>
          </FlowRow>
          ...
          <FlowNode variant="compute" size="sm">
            <FlowColumn gap={1} align="center">
              ...
              <span class="text-[10px] opacity-70">1 core, 1GB</span>
            </FlowColumn>
          </FlowNode>

          {/* Shared volumes */}
          <div class="text-xs text-[var(--ink-muted)] text-center space-y-0.5">

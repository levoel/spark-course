    ...
    <DiagramContainer title="Databricks Architecture" color="rose">
      <FlowColumn gap={12} align="center">
        <div className="w-full max-w-md rounded-xl border border-rose-400/20 bg-rose-500/5 p-4">
          <div className="text-xs text-rose-700/70 mb-2">managed by Databricks</div>
          ...
          <div className="mt-2 flex flex-wrap gap-2 justify-center">
            <span className="text-[10px] text-rose-700 bg-rose-500/10 rounded px-2 py-0.5">
              Workspace Manager
            </span>
            <span className="text-[10px] text-rose-700 bg-rose-500/10 rounded px-2 py-0.5">
              Jobs Scheduler
        ...
        <div className="w-full max-w-md rounded-xl border border-blue-400/20 bg-blue-500/5 p-4">
          <div className="text-xs text-blue-700/70 mb-2">your cloud</div>
          ...
          <div className="mt-2 flex flex-wrap gap-2 justify-center">
            <span className="text-[10px] text-blue-700 bg-blue-500/10 rounded px-2 py-0.5">
              Compute Clusters
            </span>
            <span className="text-[10px] text-blue-700 bg-blue-500/10 rounded px-2 py-0.5">
              Delta Lake Storage

  ...
  return (
    <DiagramContainer title="YARN Architecture" color="amber">
      <FlowColumn gap={12} align="center">
        <div class="w-full max-w-sm rounded-xl border border-amber-400/20 bg-amber-500/5 p-4">
          <FlowNode variant="cluster" size="md" className="w-full">
            <FlowColumn gap={1} align="center">
              <span>ResourceManager</span>
              <span class="text-xs opacity-70">глобальный планировщик</span>
            </FlowColumn>
          </FlowNode>
          <div class="mt-2 flex gap-2">
            <span class="text-[10px] text-amber-700 bg-amber-500/10 rounded px-2 py-0.5">
        ...
        <FlowRow gap={6} wrap align="center">
          {[1, 2, 3].map((i) => (
            <div
              ...
              class="rounded-xl border border-blue-400/20 bg-blue-500/5 p-3"
            >
              ...
              <div class="mt-2 flex flex-col gap-1">
                {[1, 2].map((c) => (
                  <span
                    ...
                    class="text-[10px] text-emerald-700 bg-emerald-500/10 rounded px-2 py-0.5 text-center"
                  >
                    Container (executor)
                  </span>
                ))}

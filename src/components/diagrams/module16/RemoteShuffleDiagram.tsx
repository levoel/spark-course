  ...
  return (
    ...
    >
      <FlowRow gap={6} wrap align="center">
        <div class="rounded-xl border border-blue-400/20 bg-blue-500/5 p-3">
          <div class="text-xs text-blue-700/70 mb-2">Executor 1 (Map)</div>
          <FlowNode variant="compute" size="sm">
            <FlowColumn gap={1} align="center">
              <span>Map Task</span>
              <span class="text-[10px] opacity-70">ShuffleClient (async)</span>
            </FlowColumn>
          </FlowNode>
        </div>
        ...
        <div class="rounded-xl border border-emerald-400/20 bg-emerald-500/5 p-3">
          <div class="text-xs text-emerald-700/70 mb-2">Shuffle Service</div>
          <FlowNode variant="service" size="sm">
            <FlowColumn gap={1} align="center">
              <span>Merged data</span>
              <span class="text-[10px] opacity-70">by partition</span>
              <span class="text-[10px] opacity-70">Replicated storage</span>
            </FlowColumn>
          </FlowNode>
        </div>
        ...
        <div class="rounded-xl border border-amber-400/20 bg-amber-500/5 p-3">
          <div class="text-xs text-amber-700/70 mb-2">Executor 3 (Reduce)</div>
          <FlowNode variant="compute" size="sm">
            <FlowColumn gap={1} align="center">
              <span>Reduce Task</span>
              <span class="text-[10px] opacity-70">Fetch merged data</span>
            </FlowColumn>
          </FlowNode>
        </div>
      </FlowRow>
